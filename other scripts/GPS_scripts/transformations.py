...
POS_Y = 0
ELEVATION = 1.5 # Camera elevation in meters
TILT = 45 # Tilt angle in degrees, 0 is facing ground, 90 is parallel to ground, 180 is facing upward
HEADING = 0
ROLL = 0
objheight = 0.1 # How high up are your objects expected to be; 0.5 works for dirt box
...
def returnSpatialLocation(boxes, image):
	...
	positions = []
	for i in range(0, num_boxes):
		positions.append(cam.spaceFromImage(locationsOnImage[i], Z = 0))
